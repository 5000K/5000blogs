...
func Serve(cfg *config.Config, repo service.PostIndexer, renderer view.Renderer, ogGen service.OGImageGenerator, iconData []byte) {
	srv := &http.Server{
...
func buildRouter(cfg *config.Config, repo service.PostIndexer, renderer view.Renderer, ogGen service.OGImageGenerator, iconData []byte) chi.Router {
