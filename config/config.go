...
type Config struct {
	...
	Paths struct {
		...
		Template string `env:"TEMPLATE_PATH" env-default:"https://raw.githubusercontent.com/5000K/5000blogs/refs/heads/stable/template/template.html" yaml:"template"`
		Icon     string `env:"ICON_PATH" env-default:"https://raw.githubusercontent.com/5000K/5000blogs/refs/heads/stable/template/icon.png" yaml:"icon"`
		Theme    string `env:"THEME_PATH" env-default:"https://raw.githubusercontent.com/5000K/5000blogs/refs/heads/stable/template/theme.base.css" yaml:"theme"`
	} `yaml:"paths"`
